...
public class ZAlertSheetViewController: ZBaseViewController {
    ...
    public var attributedButtonColor = ZAlertView.shared.attributedButtonColor.color
    public var attributedCancelColor = ZAlertView.shared.attributedCancelColor.color
    ...
    public var attributedLineColor = "#2D2638".color
    ...
    private lazy var viewContent: UIView = {
        let temp = UIView.init(frame: CGRect.init(10.scale, kScreenHeight, kScreenWidth, 50.scale * CGFloat(buttons.count)))
    ...
    private lazy var btnCancel: UIButton = {
        let temp = UIButton.init(frame: CGRect.init(10.scale, viewContent.y + viewContent.height + 10.scale, 355.scale, 50.scale))
    ...
    public override func viewDidLoad() {
        ...
        for (i, text) in self.buttons.enumerated() {
            ...
            if i < self.buttons.count - 1 {
                let line = UIView.init(frame: CGRect.init(0, btny + temp.height, btnw, 1))
