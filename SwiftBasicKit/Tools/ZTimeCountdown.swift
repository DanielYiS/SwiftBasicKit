...
class ZTimeCountdown: NSObject {
    ...
    /// 回调 计算好的 天、时、分、秒
    var onZTimeCountdownBlock: ((_ day: String, _ hour: String, _ minute: String, _ second: String) -> Void)?
    /// 开始启动定时器，需传入结束时间
    ...
    private func createTimer() {
        ...
        dateFormatter.dateFormat = ZKey.timeFormat.yyyyMMddHHmm
