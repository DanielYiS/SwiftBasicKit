...
public class ZRecordManager: NSObject {
    ...
    public final func startRecord() {
        ...
        do {
            ...
            self.recorder?.record(forDuration: TimeInterval(self.maxTime))
    ...
    private final func updateMeters() {
        ...
        repeat {
            ...
            BFLog.error("recordUpdateMetra lowPassResult: \(lowPassResult), currentTime: \(recorder.currentTime), deviceCurrentTime: \(recorder.deviceCurrentTime)")
