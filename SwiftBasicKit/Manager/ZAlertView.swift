...
public struct ZAlertView {
    ...
    var backgroundColor: String = "#100D13"
    var attributedContentStyle: UIBlurEffect.Style = .dark
    var attributedButtonColor: String = "#7037E9"
    var attributedCancelColor: String = "#56565C"
    var attributedTitleColor: String = "#E9E9E9"
    var attributedMessageColor: String = "#E9E9E9"
    
    static var shared = ZAlertView()
